...
export class MemberNotificationController {
    ...
    @ApiOperation({ summary: 'Member: get notification preferences' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: update notification preferences' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: list notifications' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: get unread notification count' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: register or refresh FCM device token' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: deactivate FCM device token' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: send a test push notification' })
    async sendTestPush(
        @Request() req,
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: mark all notifications as read' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: delete all notifications' })
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: mark a notification as read' })
    async markRead(
        @Request() req,
    ...
    @UseGuards(RolesGuard)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: delete a notification' })
