...
export class MemberChatController {
    ...
    @ApiOperation({ summary: 'Member: Start or get an existing member-trainer conversation' })
    ...
    @Get('conversations')
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: List conversations' })
    ...
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: List messages in a conversation' })
    ...
    @HttpCode(201)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: Send a message' })
    async sendMessage(
    ...
    @HttpCode(201)
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: Upload and send an image message' })
    ...
    @AllowedRoles(Roles.Member)
    @ApiOperation({ summary: 'Member: Mark conversation messages as seen' })
